...
@include 'miniproj\Login_Signup\connect.php';
...
if (isset($_POST['submit'])) {
    ...
    if (count($errors) == 0) {
        ...
        if (mysqli_num_rows($results) == 1) {
          ...
          header('location: http://127.0.0.1:5500/miniproj/index2.html');
        }else {
...
<form class="form" id="login">
            ...
            <button class="form__button" name="submit" type="submit"><a href="http://127.0.0.1:5500/miniproj/index2.html">Continue</a></button>
            <p class="form__text">
