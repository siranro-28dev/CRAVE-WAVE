...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($result) > 0){
      ...
      if($pass != $cpass){
         ...
         $insert = ("INSERT INTO registration VALUES('$name','$email',$pass,$cpass,$calories,'$habits')");
  ...
  <!-- <head>
    ...
    <div class="container">
        ...
        <form  id="createAccount" action="" method="POST">
            ...
            <div class="form__input-group">
                <input type="number" id="Calorie" class="form__input" autofocus placeholder="Daily_Calorie_Intake" name="Daily_Calorie_Intake" />
                <div class="form__input-error-message"></div>
            </div>
            <div class="form__input-group">
